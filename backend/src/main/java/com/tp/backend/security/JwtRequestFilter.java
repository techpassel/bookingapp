...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if(username !=null){
            ...
            if(isTokenValid){
                //Here we are manually creating "UsernamePasswordAuthenticationToken" after validating token so that
                //spring security can verify it allows for further processing.
